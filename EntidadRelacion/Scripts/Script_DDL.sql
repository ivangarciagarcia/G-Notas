...
score_type enum('PRACTICA','TEORICA') ,
...
evaluation_theory_percentage integer,
evaluation_practice_percentage integer,
evaluation_percentage integer,
module_id integer references gnotas_g2_module(module_id) on delete set null
);
...
CONSTRAINT student_module_id PRIMARY KEY (student_id , course_module_id)
);
